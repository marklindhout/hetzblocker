  ...
  function () {
    return {
      ...
      normalizeStateArg: function (state) {
        if (hetzblocker.background.browserbutton.isValidState(state)) {
          return state
        }
      ...
      setBrowserButtonTitle: function (state) {
        var ns = hetzblocker.background.browserbutton.normalizeStateArg(state)
      ...
      setBrowserButtonState: function (state) {
        hetzblocker.background.browserbutton.setBrowserButtonIcon(state)
        hetzblocker.background.browserbutton.setBrowserButtonTitle(state)
      }
