...
gulp.task('script:extensionPage:lint', function () {
  return gulp.src(config.sourceFolder + '/js/extensionPage/**/*.js')
    .pipe(gulpStandard())
...
gulp.task('script:extensionPage:build', function () {
  return gulp.src(config.sourceFolder + '/js/extensionPage/main.js', { read: false })
    ...
    .pipe(gulpRename('extensionPage.js'))
    .pipe(gulpUglify())
...
gulp.task('script:extensionPage',
  gulp.series('script:extensionPage:lint', 'script:extensionPage:build'))
...
gulp.task('script', gulp.parallel('script:content', 'script:background', 'script:extensionPage'))
